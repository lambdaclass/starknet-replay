array=( \
    0x959adba8609be5294121e8bba114d663aeff1b829935e69aba781ff2368b0f \
...
for element in "${array[@]}"; do
   # starkli class-by-hash "$element" --rpc https://mainnet.juno.internal.lambdaclass.com >> contracts/"$element".contract_class.json
   cargo run --bin contract-to-sierra contracts/"$element".contract_class.json >> contracts/"$element".sierra
done 
